...
The app supports all of the most common image types. If you enter an url which is not applicable, the app will tell you by displaying an error message. The error message **some supported image types**. For example, common *.webp* images are supported.
